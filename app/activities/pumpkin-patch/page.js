            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.body}>
                    <div className={styles.andImage}>
                        ...
                        <img src="https://www.imperial-library.info/wp-content/uploads/image-2-1024x737.png"></img>
                    </div>
                    <div className={styles.andImage}>
                        <div>
                            <h2>Pricing</h2>
                        ...
                        <img src="https://images.unsplash.com/photo-1696629842172-1b71b45e8e07?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img>
                    </div>
                    <div className={styles.andImage}>
                        <div>
                        ...
                        <img src="https://images.unsplash.com/photo-1740578266454-eee1d51fe7ff?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img>
                    </div>
                    <div className={styles.andImage}>
                        <div>
                            <h2>Variety</h2>
