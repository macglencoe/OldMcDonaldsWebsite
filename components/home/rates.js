      ...
      <div className="p-6 text-center border-b border-foreground/30">
        {Icon && (
          <Icon
            size={48}
            weight="duotone"
            className="mx-auto mb-2 text-accent group-hover:animate-bounce"
          />
        )}
