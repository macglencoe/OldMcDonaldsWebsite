...
export default function FarmSwapBanner() {
    ...
    return (
        <div className="bg-foreground " style={{
            ...
            <div className="backdrop-blur-sm py-9 px-2 md:px-5 flex flex-col md:flex-row items-center flex-wrap text-background bg-foreground/50" style={{
                backgroundImage: "linear-gradient(var(--foreground) 0%, transparent 30%, transparent 60%, var(--foreground) 100%)"
            }}>
