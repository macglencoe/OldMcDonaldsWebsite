...
function shouldProtect(req: NextRequest): boolean {
  ...
  if (req.nextUrl.pathname.startsWith("/maze-entries") || req.nextUrl.pathname.startsWith("/reservation-requests")) return true;
...
export function middleware(req: NextRequest) {
  ...
  if (auth === expected) {
    ...
    if (req.nextUrl.pathname.startsWith("/maze-entries") || req.nextUrl.pathname.startsWith("/reservation-requests")) {
