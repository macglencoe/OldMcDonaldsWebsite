    ...
    <section className={`${styles.section} ${styles.storySection}`} aria-labelledby="farm-story-heading">
      <div className={`${styles.inner} ${styles.storyGrid}`}>
        ...
        <div className={styles.storyCopy}>
          ...
          <p>
            Glencoe Farm has been part of the McDonald family story for more than 250 years. {settings.season.weekendCount} weekends each fall, we open our home place to the community and share the fields, traditions, and simple pleasures that keep us connected to this land.
          </p>
          <p>
